...
CREATE TABLE `voluntario` (
  ...
  CONSTRAINT `voluntario_ibfk_1` FOREIGN KEY (`id_cargo_voluntario`) REFERENCES `cargo_voluntario` (`id`),
  CONSTRAINT `voluntario_ibfk_2` FOREIGN KEY (`id_usuario`) REFERENCES `usuario` (`id`)
