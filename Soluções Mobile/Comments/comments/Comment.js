...
export default function Comment({comment, replies}) {
    //renderizar o comentário com o parâmetro comment que recebe comm (no elemento Comments)
    return (
        <View style={styles.comment} >
            ...
            <View style={styles.comment_right_part}>
                ...
                <View style={styles.comment_content}>
                    <View style={styles.comment_author}>{comment.username}</View>
                    <View>{comment.createdAt}</View>
                </View>

                <View style={styles.comment_text}>{comment.body}</View>
